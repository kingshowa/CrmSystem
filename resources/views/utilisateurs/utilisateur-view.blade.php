    ...
    <!-- Recent Sales -->
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h5 class="card-title"><a href="utilisateurs-add.html"><button type="button" class="btn btn-secondary btn-sm"><i class="bi bi-plus-circle me-1"></i>Add Utilisateurs</button></a></h5>
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>0554107003</td>
                    <td><a class="collapsed" href="utilisateurs-details.html"><button class="btn btn-light btn-sm"><i class="bi bi-eye-fill"></i></button></a></td>
